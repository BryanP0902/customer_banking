...
def main():
    ...
    print(f"The future savings account balance after {savings_maturity} months is: ${updated_savings_balance:.2f}")
    ...
    print(f"The interest earned on the CD is: ${interest_earned:.2f}")
    print(f"The future CD account balance after {cd_maturity} months is: ${updated_cd_balance:.2f}")
